...
namespace AionLootCounter
{
    ...
    public class MessageBoxEx
    {
        ...
        {
            if (_hHook != IntPtr.Zero) throw new NotSupportedException("multiple calls are not supported");
            if (_owner != null) _hHook = SetWindowsHookEx(WH_CALLWNDPROCRET, _hookProc, IntPtr.Zero, (int)GetCurrentThreadId());
        }
